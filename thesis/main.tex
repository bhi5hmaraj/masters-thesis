...
\usepackage[backend=bibtex,style=ACM-Reference-Format,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\newtheorem{HXf}{Fact}
\newtheorem{HXcl}{Claim}

\newtheorem{IP}{Problem}

\newtheorem{Bt}{Theorem}
\newtheorem{Bl}{Lemma}
% \newtheorem{Hc}{Corollary}
\newtheorem{Bd}{Definition}
\newtheorem{Bf}{Fact}
% \newtheorem{HXcl}{Claim}
...
\faculty{\href{https://www.cmi.ac.in/~sdatta/}{Samir Datta}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
